...
(function(exports) {
  ...
  exports["showImpl"] = $foreign.showImpl;;
              ...
              return function (button) {
                  return function (_4) {
                      return function __do() {
                          Control_Monad_Eff_Console.log("triggered")();
                          var _0 = Data_DOM_Simple_Element.hasAttribute(__dict_Element_1)("checked")(button)();
                          Control_Monad_Eff_Console.log("toggling" + (function () {
                              if (_0) {
                                  return "off";
                              };
                              if (!_0) {
                              ...
                              throw new Error("Failed pattern match at Fork line 28, column 1 - line 29, column 1: " + [ _0.constructor.name ]);
                          })())();
                          var alterButton = $amp("checked")((function () {
                              ...
                              throw new Error("Failed pattern match at Fork line 36, column 7 - line 42, column 3: " + [ _0.constructor.name ]);
                          })());
                          var alterElements = $amp("hidden")((function () {
                              ...
                              throw new Error("Failed pattern match at Fork line 42, column 7 - line 48, column 3: " + [ _0.constructor.name ]);
                          })());
                          alterButton(button)();
  ...
  var main = (function () {
      var main$prime = function (_5) {
          return function __do() {
              ...
              Control_Monad_Eff_Console.log("executing")();
              ...
              return (function () {
                  if (_2 instanceof Data_Maybe.Just) {
                      return function __do() {
                          ...
                          Control_Monad_Eff_Console.log(Prelude.show(Prelude.showArray(Data_DOM_Simple_Element.showHtmlElement))(_1))();
                          Control_Monad_Eff_Console.log(Prelude.show(Data_DOM_Simple_Element.showHtmlElement)(_2.value0))();
                          return Prelude["void"](Control_Monad_Eff.functorEff)(Data_DOM_Simple_Events.addMouseEventListener(Data_DOM_Simple_Events.mouseEventTargetHTMLElement)(Data_DOM_Simple_Events.mouseEventDOMEvent)(Data_DOM_Simple_Events.MouseClickEvent.value)(toggleForks(Data_DOM_Simple_Element.htmlElement)(Data_DOM_Simple_Element.htmlElement)(_1)(_2.value0))(_2.value0))();
                      };
                  };
                  if (_2 instanceof Data_Maybe.Nothing) {
                      return Prelude["return"](Control_Monad_Eff.applicativeEff)(Prelude.unit);
                  };
                  throw new Error("Failed pattern match at Fork line 57, column 5 - line 58, column 5: " + [ _2.constructor.name ]);
              })()();
          };
      };
